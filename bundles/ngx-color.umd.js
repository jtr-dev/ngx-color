(function (global, factory) {
    ...
    var ShadeComponent = /** @class */ (function () {
        ...
        ShadeComponent.prototype.ngOnChanges = function () {
            var colorGradient = "linear-gradient(to right,\n      hsl(" + this.hsl.h + ", 90%, 55%),\n      #000)";
            var whiteToBlackGradient = "linear-gradient(to right, #fff, #000)";
            var bgGradient = this.bnw ? whiteToBlackGradient : colorGradient;
            this.gradient = {
